...
extern int mrpadd_count;
extern double mrpadd_time;
extern double muldvd_time;
extern double muldvd2_time;
extern double muldvm_time;
extern double muldiv_time;
extern double redc_time;
extern int mrpsub_count;
extern double mrpsub_time;
extern int muldvd2_count;
extern int muldvd_count;
extern int muldiv_count;
extern int muldvm_count;
extern int mrshift_count;
extern int mr_shiftbits_count;
extern struct timeval t1;
extern struct timeval t2;
extern int mad_count;
extern int redc_count;
extern int mult_g1_count;
extern int mult_g2_count;
extern int mr_padd_op_1_len;
extern int mr_padd_op_2_len;
extern int mr_padd_op_3_len;
extern int mr_psub_op_1_len;
extern int mr_psub_op_2_len;
extern int mr_psub_op_3_len;
extern int mr_redc_op1_len;
extern int mr_redc_op2_len;
//extern big monty_modulus;
//extern mr_small monty_ndash;
